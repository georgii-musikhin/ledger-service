...
class GrpcConfig {
  ...
  /** Remove these imports after release of grpc-spring-boot-starter */
  @Configuration
  ...
  public static class DevhClientAutoConfigurations {}
  ...
  public static class DevhServerAutoConfigurations {}
}
